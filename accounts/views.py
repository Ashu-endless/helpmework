...
def homepage(request):
    ...
    return render(request, "home.html",{'context':context,'homeworks':homeworks,'userprofile':mainProfile,'Questions':questions})
...
def sharehomework(request):
    if request.method == 'POST':
       ...
       # imgs = ['data:image/jpeg;base64,','https://static.simpsonswiki.com/images/thumb/e/ed/Bart_Gets_an_F_promo.jpg/250px-Bart_Gets_an_F_promo.jpg']
        shared_hw = helpmework(postedby=request.user,description=homework_about,imgsrcs=homework_imgs,subject=homework_sub,workdone_date=homework_donedate)
        ...
        if q_id != 'none':
            ...
            print(question)
            question.homework_ids.append(int(shared_hw.id))
            question.save()
            print(question)
        #print('share')
        return redirect('home')
...
def update_to_pending_works(request):
    if request.method == 'POST':
        ...
        mainProfile = MainProfile.objects.get(user=request.user.id)
        print(mainProfile.pending_works)
        if int(homework_id) in mainProfile.pending_works:
            mainProfile.pending_works.remove(int(homework_id))
            mainProfile.save()
            return JsonResponse({'success':'removed'})
        else:
            mainProfile.pending_works.append(homework_id)
            mainProfile.save()
...
def delete_homework(request):
    if request.method == 'POST':
        homework_id = request.POST.get('homework_id')
        homework = helpmework.objects.get(id=homework_id)
        homework.delete()
...
def upload_question(request):
    if request.method == 'POST':
        question_ = request.POST.get('question')
        asked = Questions(user=request.user,question=question_)
        asked.save()
        return redirect('home')

def update_asked_worklist(request):
    pass

def update_Waiting(request):
    pass


def view_askedwork(request,q_id,q):
    question = Questions.objects.get(id=q_id)
    try:
        mainProfile = MainProfile.objects.get(user=request.user.id)
    except:
        mainProfile = ""
    homeworks = helpmework.objects.all()
    return render(request, "asked_works.html",{'question':question,'userprofile':mainProfile,'homeworks':homeworks,})
